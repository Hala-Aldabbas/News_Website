        ...
        <div class='row g-0'>
            ...
            <div class='col-md-8'>
                <div class='card-body'>
                    ...
                    <div class='py-2'>
                        <a href='category.php?cid={$rows['cid']}&cname={$rows['cname']}' class='mx-1'> {$rows['cname']}</a><span class='mx-1'></span>
                    </div>
...
<body>
    <div class="container-fluid">
        <div class="row logo">
            <div class="col-md-4 m-auto text-center"><h1><a href="index.php">BBC News</a></h1></div>
        </div>
        <div class="row">
            <nav class="navbar navbar-dark bg-dark navbar-expand-sm">
                            ...
                            if($err = mysqli_error($conn)){
                                ...
                                if(mysqli_num_rows($result2) > 0){
                                    while($rows2 = mysqli_fetch_assoc($result2)){
                                        ...
                                        echo "<li class='nav-item mx-5'><a class='nav-link $active' href='category.php?cid={$rows2['cid']}&cname={$rows2['cname']}'>{$rows2['cname']}</a></li>";
                                    }
                                }else{
                ...
                <li class="nav-item mx-5 "><h5><a class='nav-link' href='admin/index.php'>login</a></h5></li>
                    </ul>
                </div>
            </nav>
        </div>
