<?php
    session_start();
    if(!isset($_SESSION['fname']) || !isset($_SESSION['id']) || !isset($_SESSION['role'])){
...
<body>
    <div class="container">
        <div class="row align-items-center logo">
            <div class="col-md-4"><h1><a href="index.php">BBC News</a></h1></div>
            <div class="col-md-5"><h5><?php echo "Hi  ". $_SESSION['fname']; ?></h5></div>
